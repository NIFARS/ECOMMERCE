            ...
            <div class="product product-style-3 equal-elem ">
                ...
                <div class="product-thumnail">
                    <a href="{{route('product.details',['slug'=>$product->slug])}}" title="{{$product->name}}">
                        <figure><img class="card-img-top" src="{{asset('assets/images/products')}}/{{$product->image}}" width="800" height="800" alt="{{$product->name}}"></figure>
                    </a>
                </div>
                ...
                <div class="product-info">
                    ...
                    <div class="product-wish">
                        ...
                        <a href="#" ><i wire:click.prevent="removeFromWishlist({{ $product->id }})" class="fa fa-heart fill-heart"> </i></a>
                            @else
