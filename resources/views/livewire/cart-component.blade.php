                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            ...
                            <p class="text-center">
                                <a href="#" wire:click.prevent ="switchToSaveLater('{{ $item->rowId }}')">Save For Later</a>
                            </p>
                        </div>
...
<p class="summary-info"><span class="title">Discount({{ Session::get('coupon')['code'] }}) <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a> </span><b class="index">- ${{ number_format($discount,2) }}</p>

    <p class="summary-info"><span class="title">Subtotal With Discount </span><b class="index">${{
      number_format( $subtotalAfterDiscount,2) }}</p>

    <p class="summary-info"><span class="title">Tax ({{ config('cart.tax') }}%)</span><b class="index">$ {{
        number_format($taxAfterDiscount,2 )}}</p>
...
@endif
                    ...
                    <div class="summary-item ">
                        <form action="" id="code-form" class="d-none" wire:submit.prevent="applyCouponCode">
                            <h4 class="title-box">
                                Coupon  Code
                            </h4>
