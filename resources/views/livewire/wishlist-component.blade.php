                ...
                <li class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ">
                    <div class="product product-style-3 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <a href="#" class="btn add-to-cart" wire:click.prevent="moveProductFromWishlistCart('{{$item->rowId}}')">Move To Cart</a>
                            <div class="product-wish">
                                <a href="#" ><i wire:click.prevent="removeFromWishlist({{ $item->model->id }})" class="fa fa-heart fill-heart"> </i></a>
