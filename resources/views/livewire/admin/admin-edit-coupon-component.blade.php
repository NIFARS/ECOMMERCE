...
<select name="" class="from-control" id="" wire:model="type">
    ...
    <option value="percent">Percent</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4" wire:ignore>
                    <input type="text" id="expiry-data" placeholder="Expiry Date" class="form-control input-md" wire:model ="expiry_data" >

               @error('expiry_data') <p class="text-danger">{{ $message }}</p>
    ...
    <script>
 $(function(){
        $('#expiry-data').datetimepicker({
            format:'Y-MM-DD'
        })
        .on('dp.change',function(ev){
            var data = $('#expiry-data').val();
            @this.set('expiry_data',data);
        });
    });
    </script>
