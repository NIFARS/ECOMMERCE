...
<head>
	...
	<title>Home</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/ni.png">
...
<li class="menu-item">
    <a href="{{ route('admin.orders') }}" title="All coupon">All Orders</a>
</li>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{ asset('assets/images/Nifras_shop__2.png') }}" alt="mercado" width="120" height="200"></a>
						</div>
